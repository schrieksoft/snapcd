...
/// <summary>
/// Tier A smoke — RunnerModuleAssignment is the representative entity for GenericRunnerChildSecuredRepository.
/// </summary>
[Collection("NewRoleBasedSharedFixture")]
public class RunnerModuleAssignment_SmokeTests : IAsyncLifetime
{
    private readonly Fixture _fixture;
    private SnapCdDbContext _dbContext = null!;

    public RunnerModuleAssignment_SmokeTests(Fixture fixture) { _fixture = fixture; }
    ...
    {
        var existing = _fixture.RunnerModuleAssignments["0Sibling"];
    ...
    {
        var target = _fixture.SmokeRunnerAssignments["RunnerModuleAssignment_SmokeTests_UpdateCan"];
        var repo = Repo(_fixture.OrganizationPrincipals["0"][OrganizationRole.Owner].DirectUser.Id);
    ...
    {
        var target = _fixture.RunnerModuleAssignments["0Sibling"];
        var repo = Repo(_fixture.NoPermissionUser.Id);
    ...
    {
        var target = _fixture.SmokeRunnerAssignments["RunnerModuleAssignment_SmokeTests_DeleteCan"];
        var repo = Repo(_fixture.OrganizationPrincipals["0"][OrganizationRole.Owner].DirectUser.Id);
    ...
    private async Task<RunnerModuleAssignment?> GetFirstAssignment(Guid principalId)
    {
    ...
    private RunnerModuleAssignmentSecuredRepository Repo(Guid principalId)
    {
