...
/// <summary>
/// Tests for Organization Owner role with Namespace entity using User as a member of a group.
...
public class OrganizationOwner_Namespace_GroupMember_Tests : TestBase
{
    public OrganizationOwner_Namespace_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Namespace_GroupMember_Tests),
            ...
            CanUpdateIds = new[] { fixture.NamespaceAdditionalTestEntities[$"{nameof(OrganizationOwner_Namespace_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.NamespaceAdditionalTestEntities[$"{nameof(OrganizationOwner_Namespace_GroupMember_Tests)}_DeleteCan"].Id },
