...
/// <summary>
/// Tests for Organization Owner role with Namespace entity using User principal (direct assignment only).
...
public class OrganizationOwner_Namespace_User_Tests : TestBase
{
    public OrganizationOwner_Namespace_User_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Namespace_User_Tests),
            ...
            CanUpdateIds = new[] { fixture.NamespaceAdditionalTestEntities[$"{nameof(OrganizationOwner_Namespace_User_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.NamespaceAdditionalTestEntities[$"{nameof(OrganizationOwner_Namespace_User_Tests)}_DeleteCan"].Id },
