...
public class OrganizationOwner_ModuleSecret_ServicePrincipal_Tests : TestBase
{
    public OrganizationOwner_ModuleSecret_ServicePrincipal_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_ModuleSecret_ServicePrincipal_Tests),
            CanGetIds = new[] { fixture.ModuleSecrets["0000"].Id, fixture.ModuleSecrets["0001"].Id },
            CanUpdateIds = new[] { fixture.ModuleSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleSecret_ServicePrincipal_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.ModuleSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleSecret_ServicePrincipal_Tests)}_DeleteCan"].Id },
