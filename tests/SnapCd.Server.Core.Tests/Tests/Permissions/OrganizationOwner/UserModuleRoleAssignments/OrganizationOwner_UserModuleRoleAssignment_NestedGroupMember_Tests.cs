...
public class OrganizationOwner_UserModuleRoleAssignment_NestedGroupMember_Tests : TestBase
{
    public OrganizationOwner_UserModuleRoleAssignment_NestedGroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_UserModuleRoleAssignment_NestedGroupMember_Tests),
            CanGetIds = new[] { fixture.UserModuleRoleAssignments["Module0000Reader"].Id },
            CanUpdateIds = new[] { fixture.UserModuleRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserModuleRoleAssignment_NestedGroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.UserModuleRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserModuleRoleAssignment_NestedGroupMember_Tests)}_DeleteCan"].Id },
