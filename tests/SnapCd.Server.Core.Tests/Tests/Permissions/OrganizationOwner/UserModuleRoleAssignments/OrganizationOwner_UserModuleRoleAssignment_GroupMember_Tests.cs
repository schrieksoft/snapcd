...
public class OrganizationOwner_UserModuleRoleAssignment_GroupMember_Tests : TestBase
{
    public OrganizationOwner_UserModuleRoleAssignment_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_UserModuleRoleAssignment_GroupMember_Tests),
            CanGetIds = new[] { fixture.UserModuleRoleAssignments["Module0000Reader"].Id },
            CanUpdateIds = new[] { fixture.UserModuleRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserModuleRoleAssignment_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.UserModuleRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserModuleRoleAssignment_GroupMember_Tests)}_DeleteCan"].Id },
