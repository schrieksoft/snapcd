...
public class OrganizationOwner_NamespaceSecret_GroupMember_Tests : TestBase
{
    public OrganizationOwner_NamespaceSecret_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_NamespaceSecret_GroupMember_Tests),
            CanGetIds = new[] { fixture.NamespaceSecrets["000"].Id, fixture.NamespaceSecrets["001"].Id },
            CanUpdateIds = new[] { fixture.NamespaceSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_NamespaceSecret_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.NamespaceSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_NamespaceSecret_GroupMember_Tests)}_DeleteCan"].Id },
