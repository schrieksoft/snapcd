...
public class OrganizationOwner_UserStackRoleAssignment_NestedGroupMember_Tests : TestBase
{
    public OrganizationOwner_UserStackRoleAssignment_NestedGroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_UserStackRoleAssignment_NestedGroupMember_Tests),
            CanGetIds = new[] { fixture.UserStackRoleAssignments["Stack00Reader"].Id },
            CanUpdateIds = new[] { fixture.UserStackRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserStackRoleAssignment_NestedGroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.UserStackRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserStackRoleAssignment_NestedGroupMember_Tests)}_DeleteCan"].Id },
