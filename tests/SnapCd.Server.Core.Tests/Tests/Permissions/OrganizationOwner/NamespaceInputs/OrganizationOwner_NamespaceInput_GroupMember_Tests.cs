...
public class OrganizationOwner_NamespaceInput_GroupMember_Tests : TestBase
{
    public OrganizationOwner_NamespaceInput_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_NamespaceInput_GroupMember_Tests),
            CanGetIds = new[] { fixture.NamespaceInputs["00000"].Id, fixture.NamespaceInputs["00001"].Id },
            CanUpdateIds = new[] { fixture.NamespaceInputAdditionalTestEntities[$"{nameof(OrganizationOwner_NamespaceInput_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.NamespaceInputAdditionalTestEntities[$"{nameof(OrganizationOwner_NamespaceInput_GroupMember_Tests)}_DeleteCan"].Id },
