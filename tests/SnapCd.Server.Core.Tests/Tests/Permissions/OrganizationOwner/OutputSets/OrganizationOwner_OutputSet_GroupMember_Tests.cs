...
public class OrganizationOwner_OutputSet_GroupMember_Tests : TestBase
{
    public OrganizationOwner_OutputSet_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_OutputSet_GroupMember_Tests),
            CanGetIds = new[] { fixture.OutputSets["00000"].Id, fixture.OutputSets["00001"].Id },
            CanDeleteIds = new[] { fixture.OutputSetAdditionalTestEntities[$"{nameof(OrganizationOwner_OutputSet_GroupMember_Tests)}_DeleteCan"].Id },
