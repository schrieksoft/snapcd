...
/// <summary>
/// Tests for Organization Owner role with Runner entity using ServicePrincipal.
...
public class OrganizationOwner_Runner_ServicePrincipal_Tests : TestBase
{
    public OrganizationOwner_Runner_ServicePrincipal_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Runner_ServicePrincipal_Tests),

            // Positive cases - Organization Owner should have full access to Org "0"
            CanGetIds = new[] { fixture.Runners["0"].Id },
            CanUpdateIds = new[] { fixture.RunnerAdditionalTestEntities[$"{nameof(OrganizationOwner_Runner_ServicePrincipal_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.RunnerAdditionalTestEntities[$"{nameof(OrganizationOwner_Runner_ServicePrincipal_Tests)}_DeleteCan"].Id },
