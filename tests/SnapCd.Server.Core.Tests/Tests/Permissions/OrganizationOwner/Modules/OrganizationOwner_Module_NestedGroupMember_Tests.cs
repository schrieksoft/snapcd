...
/// <summary>
/// Tests for Organization Owner role with Module entity using User as a nested group member.
...
public class OrganizationOwner_Module_NestedGroupMember_Tests : TestBase
{
    public OrganizationOwner_Module_NestedGroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Module_NestedGroupMember_Tests),
            ...
            CanUpdateIds = new[] { fixture.ModuleAdditionalTestEntities[$"{nameof(OrganizationOwner_Module_NestedGroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.ModuleAdditionalTestEntities[$"{nameof(OrganizationOwner_Module_NestedGroupMember_Tests)}_DeleteCan"].Id },
