...
/// <summary>
/// Tests for Organization Owner role with Module entity using User principal (direct assignment only).
...
public class OrganizationOwner_Module_User_Tests : TestBase
{
    public OrganizationOwner_Module_User_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Module_User_Tests),
            ...
            CanUpdateIds = new[] { fixture.ModuleAdditionalTestEntities[$"{nameof(OrganizationOwner_Module_User_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.ModuleAdditionalTestEntities[$"{nameof(OrganizationOwner_Module_User_Tests)}_DeleteCan"].Id },
