...
public class OrganizationOwner_Input_NestedGroupMember_Tests : TestBase
{
    public OrganizationOwner_Input_NestedGroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Input_NestedGroupMember_Tests),
            ...
            CanDeleteIds = new[] { fixture.InputAdditionalTestEntities[$"{nameof(OrganizationOwner_Input_NestedGroupMember_Tests)}_DeleteCan"].Id },
