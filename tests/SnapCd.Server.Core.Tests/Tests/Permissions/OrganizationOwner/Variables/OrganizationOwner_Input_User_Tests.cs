...
public class OrganizationOwner_Input_User_Tests : TestBase
{
    public OrganizationOwner_Input_User_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Input_User_Tests),
            ...
            CanDeleteIds = new[] { fixture.InputAdditionalTestEntities[$"{nameof(OrganizationOwner_Input_User_Tests)}_DeleteCan"].Id },
