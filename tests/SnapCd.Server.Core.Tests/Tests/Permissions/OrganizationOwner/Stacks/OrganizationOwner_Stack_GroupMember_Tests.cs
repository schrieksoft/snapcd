...
/// <summary>
/// Tests for Organization Owner role with Stack entity using User as a member of a group.
...
public class OrganizationOwner_Stack_GroupMember_Tests : TestBase
{
    public OrganizationOwner_Stack_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Stack_GroupMember_Tests),
            ...
            CanUpdateIds = new[] { fixture.StackAdditionalTestEntities[$"{nameof(OrganizationOwner_Stack_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.StackAdditionalTestEntities[$"{nameof(OrganizationOwner_Stack_GroupMember_Tests)}_DeleteCan"].Id },
