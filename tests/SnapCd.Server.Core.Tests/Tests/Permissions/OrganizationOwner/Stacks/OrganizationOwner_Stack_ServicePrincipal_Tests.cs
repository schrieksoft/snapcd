...
/// <summary>
/// Tests for Organization Owner role with Stack entity using ServicePrincipal.
...
public class OrganizationOwner_Stack_ServicePrincipal_Tests : TestBase
{
    public OrganizationOwner_Stack_ServicePrincipal_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Stack_ServicePrincipal_Tests),
            ...
            CanUpdateIds = new[] { fixture.StackAdditionalTestEntities[$"{nameof(OrganizationOwner_Stack_ServicePrincipal_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.StackAdditionalTestEntities[$"{nameof(OrganizationOwner_Stack_ServicePrincipal_Tests)}_DeleteCan"].Id },
