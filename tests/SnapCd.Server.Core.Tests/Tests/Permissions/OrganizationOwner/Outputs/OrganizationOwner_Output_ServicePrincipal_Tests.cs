...
public class OrganizationOwner_Output_ServicePrincipal_Tests : TestBase
{
    public OrganizationOwner_Output_ServicePrincipal_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_Output_ServicePrincipal_Tests),
            CanGetIds = new[] { fixture.Outputs["00000"].Id, fixture.Outputs["00001"].Id },
            CanDeleteIds = new[] { fixture.OutputAdditionalTestEntities[$"{nameof(OrganizationOwner_Output_ServicePrincipal_Tests)}_DeleteCan"].Id },
