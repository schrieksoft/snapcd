...
/// <summary>
/// Tests for Organization Owner role with ModuleInput entity using User principal (direct assignment only).
...
public class OrganizationOwner_ModuleInput_User_Tests : TestBase
{
    public OrganizationOwner_ModuleInput_User_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_ModuleInput_User_Tests),
            ...
            CanUpdateIds = new[] { fixture.ModuleInputAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleInput_User_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.ModuleInputAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleInput_User_Tests)}_DeleteCan"].Id },
