...
/// <summary>
/// Tests for Organization Owner role with ModuleInput entity using User as a member of a group.
...
public class OrganizationOwner_ModuleInput_GroupMember_Tests : TestBase
{
    public OrganizationOwner_ModuleInput_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_ModuleInput_GroupMember_Tests),
            ...
            CanUpdateIds = new[] { fixture.ModuleInputAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleInput_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.ModuleInputAdditionalTestEntities[$"{nameof(OrganizationOwner_ModuleInput_GroupMember_Tests)}_DeleteCan"].Id },
