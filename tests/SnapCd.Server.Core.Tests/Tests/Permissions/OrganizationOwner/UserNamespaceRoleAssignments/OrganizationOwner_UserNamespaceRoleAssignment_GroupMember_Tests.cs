...
public class OrganizationOwner_UserNamespaceRoleAssignment_GroupMember_Tests : TestBase
{
    public OrganizationOwner_UserNamespaceRoleAssignment_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_UserNamespaceRoleAssignment_GroupMember_Tests),
            CanGetIds = new[] { fixture.UserNamespaceRoleAssignments["Namespace000Reader"].Id },
            CanUpdateIds = new[] { fixture.UserNamespaceRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserNamespaceRoleAssignment_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.UserNamespaceRoleAssignmentAdditionalTestEntities[$"{nameof(OrganizationOwner_UserNamespaceRoleAssignment_GroupMember_Tests)}_DeleteCan"].Id },
