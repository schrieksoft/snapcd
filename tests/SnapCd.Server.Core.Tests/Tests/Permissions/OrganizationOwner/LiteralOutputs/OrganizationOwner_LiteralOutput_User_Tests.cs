...
public class OrganizationOwner_LiteralOutput_User_Tests : TestBase
{
    public OrganizationOwner_LiteralOutput_User_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_LiteralOutput_User_Tests),
