...
public class OrganizationOwner_LiteralOutput_GroupMember_Tests : TestBase
{
    public OrganizationOwner_LiteralOutput_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_LiteralOutput_GroupMember_Tests),
