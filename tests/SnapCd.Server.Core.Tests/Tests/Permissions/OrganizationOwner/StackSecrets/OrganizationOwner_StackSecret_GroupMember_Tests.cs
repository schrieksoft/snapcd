...
public class OrganizationOwner_StackSecret_GroupMember_Tests : TestBase
{
    public OrganizationOwner_StackSecret_GroupMember_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_StackSecret_GroupMember_Tests),
            CanGetIds = new[] { fixture.StackSecrets["000"].Id, fixture.StackSecrets["001"].Id },
            CanUpdateIds = new[] { fixture.StackSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_StackSecret_GroupMember_Tests)}_UpdateCan"].Id },
            CanDeleteIds = new[] { fixture.StackSecretAdditionalTestEntities[$"{nameof(OrganizationOwner_StackSecret_GroupMember_Tests)}_DeleteCan"].Id },
