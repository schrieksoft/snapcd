...
public class OrganizationOwner_VariableSet_ServicePrincipal_Tests : TestBase
{
    public OrganizationOwner_VariableSet_ServicePrincipal_Tests(Fixture fixture)
    ...
    private static TestScenarioConfiguration CreateConfig(Fixture fixture)
    {
        return new TestScenarioConfiguration
        {
            ...
            NamePrefix = nameof(OrganizationOwner_VariableSet_ServicePrincipal_Tests),
            ...
            CanDeleteIds = new[] { fixture.VariableSetAdditionalTestEntities[$"{nameof(OrganizationOwner_VariableSet_ServicePrincipal_Tests)}_DeleteCan"].Id },
