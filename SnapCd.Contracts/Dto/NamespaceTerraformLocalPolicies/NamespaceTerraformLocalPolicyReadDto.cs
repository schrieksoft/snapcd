...
namespace SnapCd.Contracts.Dto.NamespaceTerraformLocalPolicies;

/// <summary>
/// DTO for reading a NamespaceTerraformLocalPolicy (GET operations).
/// </summary>
public class NamespaceTerraformLocalPolicyReadDto
{
    /// <summary>Unique ID of the NamespaceTerraformLocalPolicy.</summary>
    ...
    /// <summary>Absolute directory path on the Runner host holding the policy bundle. Operator-managed: the contents at evaluation time are whatever the folder holds — there is no revision pinning.</summary>
