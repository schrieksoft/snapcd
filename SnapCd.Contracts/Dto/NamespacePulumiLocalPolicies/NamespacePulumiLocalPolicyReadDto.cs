...
/// <summary>
/// DTO for reading a NamespacePulumiLocalPolicy (GET operations).
/// </summary>
public class NamespacePulumiLocalPolicyReadDto
{
    /// <summary>Unique ID of the NamespacePulumiLocalPolicy.</summary>
