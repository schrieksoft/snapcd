...
/// <summary>DTO for creating a new NamespaceIntegrationEvent (POST operations).</summary>
public class NamespaceIntegrationEventCreateDto
{
    /// <summary>ID of the target integration.</summary>
    public Guid IntegrationId { get; set; }

    /// <summary>ID of the Namespace this event is scoped to.</summary>
