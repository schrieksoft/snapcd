...
/// <summary>
/// DTO for creating a new NamespaceMission (POST operations).
/// Fires for events for any module within the targeted namespace.
/// </summary>
public class NamespaceMissionCreateDto
{
    /// <summary>ID of the Agent that runs this Mission.</summary>
    public Guid AgentId { get; set; }

    /// <summary>ID of the Namespace this Mission is scoped to.</summary>
