...
namespace SnapCd.Contracts.Dto.ModuleTerraformLocalPolicies;

/// <summary>
/// DTO for reading a ModuleTerraformLocalPolicy (GET operations).
/// </summary>
public class ModuleTerraformLocalPolicyReadDto
{
    /// <summary>Unique ID of the ModuleTerraformLocalPolicy.</summary>
