...
/// <summary>
/// DTO for reading a ModulePulumiInlinePolicy (GET operations).
/// </summary>
public class ModulePulumiInlinePolicyReadDto
{
    /// <summary>Unique ID of the ModulePulumiInlinePolicy.</summary>
