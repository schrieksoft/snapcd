...
namespace SnapCd.Contracts.Dto.NamespacePulumiRemotePolicies;

/// <summary>
/// DTO for reading a NamespacePulumiRemotePolicy (GET operations).
/// </summary>
public class NamespacePulumiRemotePolicyReadDto
{
    /// <summary>Unique ID of the NamespacePulumiRemotePolicy.</summary>
