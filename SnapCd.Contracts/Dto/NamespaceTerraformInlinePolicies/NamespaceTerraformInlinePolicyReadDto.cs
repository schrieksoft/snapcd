...
namespace SnapCd.Contracts.Dto.NamespaceTerraformInlinePolicies;

/// <summary>
/// DTO for reading a NamespaceTerraformInlinePolicy (GET operations).
/// </summary>
public class NamespaceTerraformInlinePolicyReadDto
{
    /// <summary>Unique ID of the NamespaceTerraformInlinePolicy.</summary>
