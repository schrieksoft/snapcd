...
/// <summary>
/// DTO for reading a ModulePulumiLocalPolicy (GET operations).
/// </summary>
public class ModulePulumiLocalPolicyReadDto
{
    /// <summary>Unique ID of the ModulePulumiLocalPolicy.</summary>
