...
public static class ControllerEndpoints
{
    ...
    public const string ModuleTerraformInlinePolicy = "api/{organizationId}/ModuleTerraformInlinePolicy";
    public const string ModuleTerraformRemotePolicy = "api/{organizationId}/ModuleTerraformRemotePolicy";
    public const string ModuleTerraformLocalPolicy = "api/{organizationId}/ModuleTerraformLocalPolicy";
    public const string ModulePulumiInlinePolicy = "api/{organizationId}/ModulePulumiInlinePolicy";
    public const string ModulePulumiRemotePolicy = "api/{organizationId}/ModulePulumiRemotePolicy";
    public const string ModulePulumiLocalPolicy = "api/{organizationId}/ModulePulumiLocalPolicy";
    public const string NamespaceTerraformInlinePolicy = "api/{organizationId}/NamespaceTerraformInlinePolicy";
    public const string NamespaceTerraformRemotePolicy = "api/{organizationId}/NamespaceTerraformRemotePolicy";
    public const string NamespaceTerraformLocalPolicy = "api/{organizationId}/NamespaceTerraformLocalPolicy";
    public const string NamespacePulumiInlinePolicy = "api/{organizationId}/NamespacePulumiInlinePolicy";
    public const string NamespacePulumiRemotePolicy = "api/{organizationId}/NamespacePulumiRemotePolicy";
    public const string NamespacePulumiLocalPolicy = "api/{organizationId}/NamespacePulumiLocalPolicy";
    ...
    public const string UserColor = "api/{organizationId}/UserColor";
}