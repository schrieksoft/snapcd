...
public static class McpSurfaceEmitter
{
    ...
    private static void EmitHeader(StringBuilder sb)
    {
        ...
        sb.AppendLine("// after changing controller annotations or XML doc comments. Do not edit by hand.");
        ...
        McpEntityInfo? entity)
    {
        ...
        var description = ResolveDescription(method, null, entity);
    ...
    {
        return ApplyEntityTemplate(ExtractSummary(method.GetDocumentationCommentXml() ?? string.Empty), entity);
    }
