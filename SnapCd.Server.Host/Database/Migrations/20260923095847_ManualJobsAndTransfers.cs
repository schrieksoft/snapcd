...
{
    /// <inheritdoc />
    public partial class ManualJobsAndTransfers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapRef = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    PrepareError = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    SourceLockedByPrincipalDiscriminator = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    SourceMergedDeclaredByPrincipalDiscriminator = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    ReceiverConsentPrincipalId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReceiverConsentPrincipalDiscriminator = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ReceiverConsentAgentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    ReceiverLockedByPrincipalDiscriminator = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    ReceiverMergedDeclaredByPrincipalDiscriminator = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
