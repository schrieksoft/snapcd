    ...
    public partial class AddUserFavorites : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavorites", x => new { x.Id, x.OrganizationId });
                    table.ForeignKey(
                        name: "FK_UserFavorites_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_Id",
                table: "UserFavorites",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_OrganizationId",
                table: "UserFavorites",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_UserId_OrganizationId",
                table: "UserFavorites",
                columns: new[] { "UserId", "OrganizationId" });

            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_UserId_OrganizationId_TargetType_TargetId",
                table: "UserFavorites",
