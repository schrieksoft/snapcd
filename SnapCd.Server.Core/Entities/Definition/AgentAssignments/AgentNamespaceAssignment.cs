...
namespace SnapCd.Server.Core.Entities.Definition.AgentAssignments;

public class AgentNamespaceAssignment : AuditBase, IEntity, IOrganizationChild, IAgentChild
{
