...
/// <summary>Supply: this integration serves every module in the given namespace.</summary>
public class IntegrationNamespaceSupply : AuditBase, IEntity, IOrganizationChild, IIntegrationChild
{
