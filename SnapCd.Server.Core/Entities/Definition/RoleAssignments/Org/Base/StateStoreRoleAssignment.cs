...
public class StateStoreRoleAssignment : AuditBase, IEntity, IOrganizationChild, IStateStoreRoleAssignment, IStateStoreChild
{
    ...
    public StateStore StateStore { get; set; } = null!;
