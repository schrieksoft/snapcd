...
/// <summary>Shared tuning for the three integration supply-assignment repositories.</summary>
public class IntegrationSupplyRepositorySettings : IEntitySettings
{
