...
/// <summary>Shared tuning for the integration role-assignment repositories (base + per-principal).</summary>
public class IntegrationRoleAssignmentRepositorySettings : IEntitySettings
{
