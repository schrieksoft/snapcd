...
/// <summary>
/// Repository event emission settings for ModulePulumiLocalPolicy entities.
/// </summary>
public class ModulePulumiLocalPolicyRepositorySettings : IEntitySettings
{
    /// <summary>When true (default), publish a CreatedEvent on the bus when a ModulePulumiLocalPolicy is created.</summary>
    public bool EmitCreateEvents { get; set; } = true;
    /// <summary>When true (default), publish an UpdatedEvent on the bus when a ModulePulumiLocalPolicy is updated.</summary>
    public bool EmitUpdateEvents { get; set; } = true;
    /// <summary>When true (default), publish a DeletedEvent on the bus when a ModulePulumiLocalPolicy is deleted.</summary>
