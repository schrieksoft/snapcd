...
/// </summary>
public class ModuleJobApprovalRepositorySettings : IEntitySettings
{
    /// <summary>When true (default), publish a CreatedEvent on the bus when a ModuleJobApproval is created.</summary>
    public bool EmitCreateEvents { get; set; } = true;
    /// <summary>When true (default), publish an UpdatedEvent on the bus when a ModuleJobApproval is updated.</summary>
    public bool EmitUpdateEvents { get; set; } = true;
    /// <summary>When true (default), publish a DeletedEvent on the bus when a ModuleJobApproval is deleted.</summary>
