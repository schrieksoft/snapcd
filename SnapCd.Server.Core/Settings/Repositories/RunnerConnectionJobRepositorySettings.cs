...
{
    /// <summary>When true (default), publish a CreatedEvent on the bus when a RunnerConnectionJob is created.</summary>
    public bool EmitCreateEvents { get; set; } = false;
    /// <summary>When true (default), publish an UpdatedEvent on the bus when a RunnerConnectionJob is updated.</summary>
    public bool EmitUpdateEvents { get; set; } = false;
    /// <summary>When true (default), publish a DeletedEvent on the bus when a RunnerConnectionJob is deleted.</summary>
