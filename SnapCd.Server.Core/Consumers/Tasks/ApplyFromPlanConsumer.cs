...
public class ApplyFromPlanConsumer : IConsumer<ApplyFromPlanRequested>
{
    ...
    public async Task Consume(ConsumeContext<ApplyFromPlanRequested> context)
    {
        ...
        _logger.LogDebug("Received ApplyFromPlan request for job {JobId} in pool {RunnerId}",
            jobId, runnerId);
        ...
        try
        {
            ...
            _logger.LogDebug("Dispatched ApplyFromPlan request to runner {RunnerName} for job {JobId}",
