...
public class AuthenticationController : Controller
{
    ...
    //[VerifyLicense(nameof(LicenseTier.SsoEnabled))]
    public async Task<ActionResult> LogInCallback()
    {
        ...
        //.SetClaim(ClaimTypes.Role, result.Principal.GetClaim("roles")); //This does not get persisted in cookie!
        ...
        properties.StoreTokens((result.Properties ?? new AuthenticationProperties()).GetTokens().Where(token => token.Name is
        ...
        var authn = SignIn(new ClaimsPrincipal(identity), properties);
        return authn;
