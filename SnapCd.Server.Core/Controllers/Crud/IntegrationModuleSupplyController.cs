...
[Route(ControllerEndpoints.IntegrationModuleSupply)]
public class IntegrationModuleSupplyController : GenericCrudController<
...
{
    public IntegrationModuleSupplyController(IntegrationModuleSupplyService service) : base(service)
    {
    }
}
