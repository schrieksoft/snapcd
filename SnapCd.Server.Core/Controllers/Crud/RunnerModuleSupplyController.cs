...
public static class RunnerModuleSupplyCustomEndpointNames
{
    public const string GetByName = "ByName";
}

[Route(ControllerEndpoints.RunnerModuleSupply)]
public class RunnerModuleSupplyController : GenericCrudController<
    RunnerModuleSupply,
...
{
    public RunnerModuleSupplyController(RunnerModuleSupplyService service) : base(service)
    {
    }
}