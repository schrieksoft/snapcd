...
[Route(ControllerEndpoints.StateFile)]
public class StateFileController : GenericCrudController<
    StateFile,
    StateFileCreateDto,
    StateFileUpdateDto,
    StateFileReadDto,
...
{
    public StateFileController(StateFileService service) : base(service)
    {
    }
}
