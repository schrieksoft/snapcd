...
[Route(ControllerEndpoints.ModulePulumiInlinePolicy)]
public class ModulePulumiInlinePolicyController : GenericCrudController<
    ...
    ModulePulumiInlinePolicySecuredRepository,
    ModulePulumiInlinePolicyRepository,
    ModulePulumiInlinePolicyService,
...
{
    public ModulePulumiInlinePolicyController(ModulePulumiInlinePolicyService service) : base(service)
    {
    }

    [HttpGet("{moduleId}/{name}")]
    public async Task<ActionResult<ModulePulumiInlinePolicyReadDto>> Get(Guid organizationId, Guid moduleId, string name)
    {
        try
        {
