...
[Route(ControllerEndpoints.NamespaceTerraformLocalPolicy)]
public class NamespaceTerraformLocalPolicyController : GenericCrudController<
    ...
    NamespaceTerraformLocalPolicySecuredRepository,
    NamespaceTerraformLocalPolicyRepository,
    NamespaceTerraformLocalPolicyService,
...
{
    public NamespaceTerraformLocalPolicyController(NamespaceTerraformLocalPolicyService service) : base(service)
    {
    }

    [HttpGet("{namespaceId}/{name}")]
    public async Task<ActionResult<NamespaceTerraformLocalPolicyReadDto>> Get(Guid organizationId, Guid namespaceId, string name)
    {
        try
        {
