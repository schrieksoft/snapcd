...
[Route(ControllerEndpoints.ModuleTerraformLocalPolicy)]
public class ModuleTerraformLocalPolicyController : GenericCrudController<
...
{
    public ModuleTerraformLocalPolicyController(ModuleTerraformLocalPolicyService service) : base(service)
    {
    }
