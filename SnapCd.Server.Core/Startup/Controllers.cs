...
public static class Controllers
{
    public static IServiceCollection AddSnapCdControllers(this IServiceCollection services, IEnumerable<Type>? additionalControllers = null)
    {
        ...
        controllers.AddRange(new[]
        {
            ...
            typeof(ModuleIntegrationEventController),
            typeof(IntegrationStackSupplyController),
            typeof(IntegrationNamespaceSupplyController),
            typeof(IntegrationModuleSupplyController),
            ...
            typeof(RunnerStackSupplyController),
            typeof(RunnerNamespaceSupplyController),
            typeof(RunnerModuleSupplyController),
            typeof(AgentStackSupplyController),
            typeof(AgentNamespaceSupplyController),
            typeof(AgentModuleSupplyController),
            ...
            typeof(ModuleTerraformInlinePolicyController),
            typeof(ModuleTerraformRemotePolicyController),
            typeof(ModuleTerraformLocalPolicyController),
            typeof(ModulePulumiInlinePolicyController),
            typeof(ModulePulumiRemotePolicyController),
            typeof(ModulePulumiLocalPolicyController),
            typeof(NamespaceTerraformInlinePolicyController),
            typeof(NamespaceTerraformRemotePolicyController),
            typeof(NamespaceTerraformLocalPolicyController),
            typeof(NamespacePulumiInlinePolicyController),
            typeof(NamespacePulumiRemotePolicyController),
            typeof(NamespacePulumiLocalPolicyController),
