...
public class UserRunnerRoleAssignmentSecuredRepositoryFactory(
    IDbContextFactory<SnapCdDbContext> dbFactory,
    IPublishEndpoint bus,
    IOptions<UserRunnerRoleAssignmentRepositorySettings> options)
{
    public UserRunnerRoleAssignmentSecuredRepository Create(IPrincipalProvider? principalProvider = null)
    {
        if (principalProvider == null)
            principalProvider = new HttpContextPrincipalProvider(new HttpContextAccessor());
        var dbContext = dbFactory.CreateDbContext();
        return new UserRunnerRoleAssignmentSecuredRepository(
            new UserRunnerRoleAssignmentRepository(dbContext, principalProvider, bus, options),
            principalProvider);
    }
}
...
public class UserRunnerRoleAssignmentSecuredRepository : GenericRunnerChildSecuredRepository<
    ...
    UserRunnerRoleAssignmentCreatedEvent,
    UserRunnerRoleAssignmentUpdatedEvent,
    UserRunnerRoleAssignmentDeletedEvent,
    UserRunnerRoleAssignmentRepositorySettings>
{
    public UserRunnerRoleAssignmentSecuredRepository(
        UserRunnerRoleAssignmentRepository repository,
