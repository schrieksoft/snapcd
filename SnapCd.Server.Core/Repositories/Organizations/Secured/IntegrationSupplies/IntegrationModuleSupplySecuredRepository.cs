    ...
    IOptions<IntegrationSupplyRepositorySettings> options)
{
    public IntegrationModuleSupplySecuredRepository Create(IPrincipalProvider? principalProvider = null)
    {
        ...
        return new IntegrationModuleSupplySecuredRepository(
            new IntegrationModuleSupplyRepository(dbContext, principalProvider, bus, options),
            principalProvider);
    }
}
    ...
    IntegrationSupplyRepositorySettings>
{
    ...
    public async Task<List<IntegrationModuleSupply>> ListByIntegration(Guid integrationId, Guid organizationId)
    {
    ...
    public async Task<List<IntegrationModuleSupply>> ListByModule(Guid moduleId, Guid organizationId)
    {
        return await ReadQuery(organizationId)
