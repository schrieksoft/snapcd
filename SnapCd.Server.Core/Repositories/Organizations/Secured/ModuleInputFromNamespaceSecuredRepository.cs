...
public class ModuleInputFromNamespaceSecuredRepositoryFactory<TEntity>(
    ...
    where TEntity : ModuleInput, IModuleInputFromNamespace
{
    public ModuleInputFromNamespaceSecuredRepository<TEntity> Create(IPrincipalProvider? principalProvider = null)
    {
        ...
        return new ModuleInputFromNamespaceSecuredRepository<TEntity>(
            new ModuleInputFromNamespaceRepository<TEntity>(dbContext, principalProvider, bus, options),
            principalProvider);
    }
}
...
public class ModuleInputFromNamespaceSecuredRepository<TEntity> : GenericModuleChildSecuredRepository<
    ...
    where TEntity : ModuleInput, IModuleInputFromNamespace
{
    public ModuleInputFromNamespaceSecuredRepository(
        ModuleInputFromNamespaceRepository<TEntity> repository,
