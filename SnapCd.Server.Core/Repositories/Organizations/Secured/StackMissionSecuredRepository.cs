...
public class StackMissionSecuredRepositoryFactory(
    IDbContextFactory<SnapCdDbContext> dbFactory,
    IPublishEndpoint bus,
    IOptions<StackMissionRepositorySettings> options)
{
    public StackMissionSecuredRepository Create(IPrincipalProvider? principalProvider = null)
    {
        if (principalProvider == null)
            principalProvider = new HttpContextPrincipalProvider(new HttpContextAccessor());
        var dbContext = dbFactory.CreateDbContext();
        return new StackMissionSecuredRepository(
            new StackMissionRepository(dbContext, principalProvider, bus, options),
            principalProvider);
    }
}

public class StackMissionSecuredRepository : GenericStackChildSecuredRepository<
    StackMission,
    StackMissionReadDto,
...
{
    public StackMissionSecuredRepository(
        StackMissionRepository repository,
    ...
    public override IQueryable<StackMission> ReadQuery(Guid organizationId)
    {
