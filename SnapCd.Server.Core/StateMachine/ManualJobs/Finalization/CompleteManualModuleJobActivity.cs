...
public class CompleteManualModuleJobActivity<TSaga, TMessage> : IStateMachineActivity<TSaga, TMessage>
    where TSaga : ManualJobSagaBase
    where TMessage : class
{
    private readonly ManualModuleJobRepository _repository;

    public CompleteManualModuleJobActivity(ManualModuleJobRepository repository)
    {
    ...
    public void Probe(ProbeContext context) => context.CreateScope("complete-manual-module-job");
