...
public partial class SplitMonolithStateMachine
{
    ...
    /// </summary>
    private static bool TimeoutIsOverdue(BehaviorContext<SplitMonolithSaga, CancelManualModuleJobRequested> context) =>
    ...
    private async Task FinalizeWithoutSaga(ConsumeContext context, Guid jobId, Guid organizationId, string eventName)
    {
        ...
        await publishEndpoint.Publish(new SplitMonolithCancelled
        {
