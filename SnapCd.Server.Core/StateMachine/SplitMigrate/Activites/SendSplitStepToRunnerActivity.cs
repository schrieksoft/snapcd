...
public class SendSplitStepToRunnerActivity<TMessage, TOutgoingMessage>
    : SendToRunnerActivity<SplitMigrateSaga, TMessage, TOutgoingMessage>
    ...
    where TOutgoingMessage : StepRequestBase, new()
{
    public SendSplitStepToRunnerActivity(
        ...
        ILogger<SendToRunnerActivity<SplitMigrateSaga, TMessage, TOutgoingMessage>> logger)
        : base(dbContext, maintenanceMode, logger)
    {
    }

    protected override TOutgoingMessage CreateMessage(SplitMigrateSaga saga)
    {
