...
/// <summary>
/// Notifies subscribers (dependency graphs) when a user's colors change. Keyed by user id, so a
/// colour picked in one tab repaints the graph in another. Same shape as
/// <see cref="FavoritesModifiedNotificationService"/>.
/// </summary>
public class ColorsModifiedNotificationService
{
