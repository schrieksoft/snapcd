...
{
    public IntegrationModuleSupplyService(
        IntegrationModuleSupplySecuredRepository securedRepository) : base(securedRepository)
    {
    }

    protected override IntegrationModuleSupply MapToEntity(IntegrationModuleSupplyCreateDto dto, Guid organizationId)
    {
        return IntegrationModuleSupplyMapper.ToEntity(dto, organizationId);
    }
    ...
    {
        IntegrationModuleSupplyMapper.UpdateEntity(entity, dto);
    }
}
