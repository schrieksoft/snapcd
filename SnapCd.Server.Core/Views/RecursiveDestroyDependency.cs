...
public class RecursiveDestroyDependency : IRecursiveDependency
{
    // Root module details (the module being depended on - preserved throughout recursion)
    ...
    // Current edge: Defined Module (source of edge - the dependent)
