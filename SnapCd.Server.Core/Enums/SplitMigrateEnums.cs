...
/// <summary>Runner callbacks a SplitMigrate job may make.</summary>
public enum SplitMigrateTaskEndpoint
{
    GetModuleCompleted,
    GetModuleCancelled,
    GetModuleFaulted,
