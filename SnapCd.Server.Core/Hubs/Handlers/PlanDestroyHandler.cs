...
public class PlanDestroyHandler
{
    ...
    public async Task Complete(Guid jobId, PlanCompletedData data)
    {
        try
        {
            ...
            _logger.LogDebug("Sent PlanDestroy completion response for job {JobId} to saga", jobId);
        }
        catch (Exception ex)
        {
    ...
    public async Task Cancel(Guid jobId)
    {
        try
        {
            ...
            _logger.LogDebug("Sent PlanDestroy cancellation response for job {JobId} to saga", jobId);
        }
        catch (Exception ex)
        {
    ...
    public async Task Fault(Guid jobId, string? errorMessage, string? stackTrace, PolicyOutcome? policyOutcome = null)
    {
        try
        {
            ...
            _logger.LogDebug("Sent PlanDestroy fault response for job {JobId} to saga", jobId);
        }
        catch (Exception ex)
        {
