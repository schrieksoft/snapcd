...
public class ModuleTerraformRemotePolicyClassMap : IEntityTypeConfiguration<ModuleTerraformRemotePolicy>
{
    public void Configure(EntityTypeBuilder<ModuleTerraformRemotePolicy> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.ModuleTerraformRemotePolicies)
