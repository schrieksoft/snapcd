...
public class AgentNamespaceSupplyClassMap : IEntityTypeConfiguration<AgentNamespaceSupply>
{
    public void Configure(EntityTypeBuilder<AgentNamespaceSupply> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.AgentNamespaceSupplies)
