...
public class ModuleParamFromSecretClassMap : IEntityTypeConfiguration<ModuleParamFromSecret>
{
    public void Configure(EntityTypeBuilder<ModuleParamFromSecret> entity)
    {
        entity
            .Property(d => d.Type)
        ...
        entity
            .HasOne(e => e.Module)
            .WithMany(x => x.ModuleParamFromSecrets)
