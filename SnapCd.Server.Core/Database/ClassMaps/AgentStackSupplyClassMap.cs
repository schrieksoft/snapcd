...
public class AgentStackSupplyClassMap : IEntityTypeConfiguration<AgentStackSupply>
{
    public void Configure(EntityTypeBuilder<AgentStackSupply> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.AgentStackSupplies)
