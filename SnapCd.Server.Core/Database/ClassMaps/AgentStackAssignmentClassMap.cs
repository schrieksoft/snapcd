...
public class AgentStackAssignmentClassMap : IEntityTypeConfiguration<AgentStackAssignment>
{
    public void Configure(EntityTypeBuilder<AgentStackAssignment> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.AgentStackAssignments)
            .HasForeignKey(e => e.OrganizationId)
            .OnDelete(DeleteBehavior.Restrict);

        entity
            .HasIndex(p => new { p.StackId, p.AgentId, p.OrganizationId })
            .IsUnique();
