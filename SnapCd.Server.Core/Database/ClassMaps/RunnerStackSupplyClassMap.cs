...
public class RunnerStackSupplyClassMap : IEntityTypeConfiguration<RunnerStackSupply>
{
    public void Configure(EntityTypeBuilder<RunnerStackSupply> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.RunnerStackSupplies)
