...
public class NamespacePulumiRemotePolicyClassMap : IEntityTypeConfiguration<NamespacePulumiRemotePolicy>
{
    public void Configure(EntityTypeBuilder<NamespacePulumiRemotePolicy> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.NamespacePulumiRemotePolicies)
            .HasForeignKey(e => e.OrganizationId)
            .OnDelete(DeleteBehavior.Restrict);

        entity.HasOne(x => x.Namespace)
            .WithMany(x => x.PulumiRemotePolicies)
