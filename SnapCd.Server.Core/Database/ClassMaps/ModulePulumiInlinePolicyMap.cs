...
public class ModulePulumiInlinePolicyClassMap : IEntityTypeConfiguration<ModulePulumiInlinePolicy>
{
    public void Configure(EntityTypeBuilder<ModulePulumiInlinePolicy> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.ModulePulumiInlinePolicies)
