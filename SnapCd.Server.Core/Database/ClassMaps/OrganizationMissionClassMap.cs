...
public class OrganizationMissionClassMap : IEntityTypeConfiguration<OrganizationMission>
{
    public void Configure(EntityTypeBuilder<OrganizationMission> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.OrganizationMissions)
            .HasForeignKey(e => e.OrganizationId)
            .OnDelete(DeleteBehavior.Restrict);

        // Unique constraint: one OrganizationMission per Agent per MissionType per Org
        entity
            .HasIndex(p => new { p.AgentId, p.OrganizationId, p.MissionType })
            .IsUnique();
