...
public class ModuleParamFromOutputClassMap : IEntityTypeConfiguration<ModuleParamFromOutput>
{
    public void Configure(EntityTypeBuilder<ModuleParamFromOutput> entity)
    {
        entity
        ...
        entity
            .HasOne(e => e.Module)
            .WithMany(x => x.ModuleParamFromOutputs)
