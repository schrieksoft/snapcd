...
public class NamespacePulumiLocalPolicyClassMap : IEntityTypeConfiguration<NamespacePulumiLocalPolicy>
{
    public void Configure(EntityTypeBuilder<NamespacePulumiLocalPolicy> entity)
    {
        ...
        entity
            ...
            .WithMany(x => x.NamespacePulumiLocalPolicies)
            .HasForeignKey(e => e.OrganizationId)
            .OnDelete(DeleteBehavior.Restrict);

        entity.HasOne(x => x.Namespace)
            .WithMany(x => x.PulumiLocalPolicies)
